...
public class PayCashCommand implements Command {
    private static final Logger logger = Logger.getLogger(PayCashCommand.class.getName());
    private PayInterfaces payMethod;
    private double amount;
    private String method;

    public PayCashCommand(PayInterfaces payMethod, double amount, String method) {
