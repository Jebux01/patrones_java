...
public class PayCardCommand implements Command {
    private static final Logger logger = Logger.getLogger(PayCardCommand.class.getName());
    private PayInterfaces payMethod;
    private double amount;
    private String method;

    public PayCardCommand(PayInterfaces payMethod, double amount, String method) {
